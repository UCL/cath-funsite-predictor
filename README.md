...
* `datasets`
  ...
  Some dataset files are very large, these can be downloaded from [here](ftp://orengoftp.biochem.ucl.ac.uk/cath/supplementary-materials/2020-cath-funsite-predictor/).
